...
const RemotionCompotions = ({ videoData, setDurationInFrames }) => {
  ...
  console.log(videoData,"videoDatavideoDatavideoDatavideoDatavideoDatavideoData");
    ...
    <div>
      <AbsoluteFill>
        {imagesList?.map((item, index) => {
          ...
          const scale = (i) => interpolate(freme, [startTime, startTime + duration / 2, startTime + duration], i % 2 === 0 ? [1, 1.8, 1] : [1.8, 1, 1.8], { extrapolateLeft: "clamp", extrapolateRight: "clamp" })
          return (
      ...
      <AbsoluteFill style={{color:"#fff",justifyContent:"center",bottom:200,height:150,textAlign:"center",top:undefined}}>
